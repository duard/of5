...
export const selectFeature = (state: RootState) => state.settings;
...
export const selectSettingsSideNav = createSelector(selectSettings, (state: SettingsState) => state.sideNav);

export const selectMenu = createSelector(selectSettings, (state: SettingsState) => state.menus);
